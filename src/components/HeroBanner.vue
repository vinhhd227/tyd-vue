<template>
  <section class="tw:relative tw:isolate" :aria-label="ariaLabel">
    ...
    >
      ...
      <picture
        v-if="hasVideoError"
        class="tw:absolute tw:inset-0 tw-hidden tw:md:block"
      >
        <img
          :src="posterSrc"
          :alt="posterAlt"
      ...
      <!-- Slot nội dung -->
      <div
        class="tw:relative tw:z-10 tw:mx-auto tw:flex tw:h-full tw:max-w-[70vw] tw:items-center tw:px-4 sm:tw:px-6 lg:tw:px-8"
      >
        <div class="tw:w-full">
